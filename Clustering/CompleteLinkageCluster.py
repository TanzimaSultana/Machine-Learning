...
class Complete_Linkage_Clustering(object):
    def __init__(self, x, no_of_clusters):
        print("Complete_Linkage_Clustering : ", no_of_clusters)
        self.x = x
    ...
    def find_clusters(self, dist_matrix):
        ...
        # Min value from the distance matrix
...
def main():
    ...
    #plot_data(X)
    for i in range(2, 5):
        Complete_Linkage_Clustering(X, i)
    Cluster_Tree(X)
